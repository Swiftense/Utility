...
#include <string.h>
    ...
    extern int shm_contains(SHashmap *hm, K key);

    /// @brief gets Value associated with a Key
    /// @param hm used SHashmap
    /// @param key used Key
    /// @return Value associated with <key>
    extern V shm_get(struct _shashmap *hm, K key);
